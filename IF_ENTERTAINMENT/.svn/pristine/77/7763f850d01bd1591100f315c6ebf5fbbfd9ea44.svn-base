...
public class GoodsServiceImpl implements IGoodsService {
	...
	public List<CartVO> goodsQuantity(List<CartVO> list) {
		 List<CartVO> quantityList = new ArrayList<>();
		 for (CartVO cartVO : list) {
		        String goodsNo = cartVO.getGoodsNo();
		        CartVO goodsArtist = goodsMapper.goodsQuantity(goodsNo);
		        quantityList.add(goodsArtist);
		    }
		return quantityList;
	}
	...
	public String membershipAuthSelect(GoodsVO goodsVO) {
		return goodsMapper.membershipAuthSelect(goodsVO);
	}

	@Override
	public Integer membershipProdWhether(GoodsVO goodsVO) {
		return goodsMapper.membershipProdWhether(goodsVO);
	}

	@Override
	public List<CartVO> gcIdList(List<CartVO> list) {
		 List<CartVO> gcList = new ArrayList<>();
		 for (CartVO cartVO : list) {
		        String goodsNo = cartVO.getGoodsNo();
		        CartVO gcId = goodsMapper.gcIdList(goodsNo);
		        gcList.add(gcId);
		    }
		return gcList;
	}
	...
	public String gaDetailimgSelect(String goodsNo) {
		return goodsMapper.gaDetailimgSelect(goodsNo);
	}

	@Override
	public List<GoodsVO> recommendGoodsList(String goodsNo) {
		
		return goodsMapper.recommendGoodsList(goodsNo);
	}
