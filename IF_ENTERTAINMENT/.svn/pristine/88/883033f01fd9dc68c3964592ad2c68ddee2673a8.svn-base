  ...
  <div class="content-area">
                ...
                <div class="buttonz">
				  <form action="/entertain/artist/profile/updateForm.do" method="get">
				    <input type="hidden" name="agId" id="agId" value="${profile.agId}">
				    <button type="submit" id="modBtn" name="modBtn" value="${name}">수정하ㅇ기</button>
				  </form>
				</div>
</div>
    <!-- /.container -->
    ...
    <script src="${pageContext.request.contextPath }/resources/full/js/main2.js"></script>
