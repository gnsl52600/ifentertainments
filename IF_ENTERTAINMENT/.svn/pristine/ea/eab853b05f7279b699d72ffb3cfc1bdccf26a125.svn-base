...
!(function (t, e) {
  ...
  function n(t) {
    ...
    if (this._options.steps)
      for (var i = [], a = 0, c = this._options.steps.length; c > a; a++) {
        ...
        if (
          ((h.step = e.length + 1),
          "string" == typeof h.element &&
            (h.element = document.querySelector(h.element)),
          "undefined" == typeof h.element || null == h.element)
        ) {
          var u = document.querySelector(".introjsFloatingElement");
          null == u &&
            ((u = document.createElement("div")),
            (u.className = "introjsFloatingElement"),
      ...
      for (var a = 0, d = i.length; d > a; a++) {
        ...
        m > 0 &&
          (e[m - 1] = {
            ...
            position:
              f.getAttribute("data-position") || this._options.tooltipPosition,
          });
      }
    ...
    if (
      ...
      (n._onKeyDown = function (e) {
        if (27 === e.keyCode && 1 == n._options.exitOnEsc)
          l.call(n, t),
            void 0 != n._introExitCallback && n._introExitCallback.call(n);
        else if (37 === e.keyCode) s.call(n);
        else if (39 === e.keyCode) r.call(n);
        else if (13 === e.keyCode) {
          var o = e.target || e.srcElement;
          o && o.className.indexOf("introjs-prevbutton") > 0
            ? s.call(n)
            : o && o.className.indexOf("introjs-skipbutton") > 0
            ? l.call(n, t)
            : r.call(n),
        ...
        (n._onResize = function () {
          p.call(n, document.querySelector(".introjs-helperLayer")),
            p.call(n, document.querySelector(".introjs-tooltipReferenceLayer"));
        }),
        window.addEventListener
          ? (this._options.keyboardNavigation &&
              window.addEventListener("keydown", n._onKeyDown, !0),
            window.addEventListener("resize", n._onResize, !0))
          : document.attachEvent &&
            (this._options.keyboardNavigation &&
              document.attachEvent("onkeydown", n._onKeyDown),
            document.attachEvent("onresize", n._onResize));
    }
    return !1;
  }
  function o(t) {
  ...
  function a(t, e, n, o) {
    ...
    if (
      ...
      "undefined" != typeof o &&
        null != o &&
        ((o.style.top = null), (o.style.left = null)),
      this._introItems[this._currentStep])
    ) {
      (i = this._introItems[this._currentStep]),
        (l =
          "string" == typeof i.tooltipClass
            ? i.tooltipClass
            : this._options.tooltipClass),
        (e.className = ("introjs-tooltip " + l).replace(/^\s+|\s+$/g, ""));
      ...
      (currentTooltipPosition = this._introItems[this._currentStep].position),
        ("auto" == currentTooltipPosition ||
          ...
          (currentTooltipPosition = c.call(this, t, e, currentTooltipPosition));
      var a = b(t),
        h = b(e).height,
        p = m();
      switch (currentTooltipPosition) {
        case "top":
          ...
          break;
        case "right":
          (e.style.left = b(t).width + 20 + "px"),
            a.top + h > p.height &&
              ((n.className = "introjs-arrow left-bottom"),
              (e.style.top = "-" + (h - a.height - 20) + "px")),
        ...
        case "floating":
          (n.style.display = "none"),
            ...
            "undefined" != typeof o &&
              null != o &&
              ((o.style.left = "-" + (r.width / 2 + 18) + "px"),
              (o.style.top = "-" + (r.height / 2 + 18) + "px"));
          break;
        case "bottom-right-aligned":
          (n.className = "introjs-arrow top-right"),
            (e.style.right = "0px"),
            (e.style.bottom = "-" + (b(e).height + 10) + "px");
          break;
        case "bottom-middle-aligned":
          (s = b(t)),
            (r = b(e)),
            (n.className = "introjs-arrow top-middle"),
            (e.style.left = s.width / 2 - r.width / 2 + "px"),
            (e.style.bottom = "-" + (r.height + 10) + "px");
          break;
        case "bottom-left-aligned":
        case "bottom":
        default:
          (e.style.bottom = "-" + (b(e).height + 10) + "px"),
            (e.style.left = b(t).width / 2 - b(e).width / 2 + "px"),
  ...
  function c(t, e, n) {
    var o = this._options.positionPrecedence.slice(),
      ...
      a = "floating";
    return (
      l.left + s > i.width || l.left + l.width / 2 - s < 0
        ? (h(o, "bottom"), h(o, "top"))
        : (l.height + l.top + r > i.height && h(o, "bottom"),
          l.top - r < 0 && h(o, "top")),
      l.width + l.left + s > i.width && h(o, "right"),
      l.left - s < 0 && h(o, "left"),
      o.length > 0 && (a = o[0]),
      n && "auto" != n && o.indexOf(n) > -1 && (a = n),
      a
    );
  }
  function h(t, e) {
  ...
  function d(t) {
    ...
    if (
      ("string" == typeof t.highlightClass && (i += " " + t.highlightClass),
      "string" == typeof this._options.highlightClass &&
        (i += " " + this._options.highlightClass),
      null != n)
    ) {
      ...
      if (
        ...
        ((null != j &&
          ...
          "floating" == j.position) ||
          ("backward" == this._direction && "floating" == t.position)) &&
          (c.style.opacity = 0);
      }
      ...
      (S.className = S.className
        ...
        (e._lastShowElementTimer = setTimeout(function () {
          null != c && (c.innerHTML = t.step),
            (h.innerHTML = t.intro),
            (y.style.display = "block"),
            a.call(e, t.element, y, d, c),
            (o.querySelector(".introjs-bullets li > a.active").className = ""),
            (o.querySelector(
              '.introjs-bullets li > a[data-stepnumber="' + t.step + '"]'
            ).className = "active"),
            o
              .querySelector(".introjs-progress .introjs-progressbar")
              .setAttribute("style", "width:" + v.call(e) + "%;"),
            (y.style.opacity = 1),
            c && (c.style.opacity = 1),
            -1 === C.tabIndex ? _.focus() : C.focus();
        }, 350));
    } else {
      ...
      (k.className = i),
        ...
        (T.innerHTML = t.intro),
        (q.className = "introjs-bullets"),
        this._options.showBullets === !1 && (q.style.display = "none");
      for (
        var H = document.createElement("ul"),
          N = 0,
          O = this._introItems.length;
        O > N;
        N++
      ) {
        ...
        (M.onclick = function () {
          ...
          N === t.step - 1 && (M.className = "active"),
          (M.href = "javascript:void(0);"),
          (M.innerHTML = "&nbsp;"),
          M.setAttribute("data-stepnumber", this._introItems[N].step),
          B.appendChild(M),
          H.appendChild(B);
      }
      q.appendChild(H),
        (A.className = "introjs-progress"),
        this._options.showProgress === !1 && (A.style.display = "none");
      var R = document.createElement("div");
      if (
        ((R.className = "introjs-progressbar"),
        R.setAttribute("style", "width:" + v.call(this) + "%;"),
        A.appendChild(R),
      ...
      (w.onclick = function () {
        ...
        (w.innerHTML = this._options.prevLabel);
      var _ = document.createElement("a");
      (_.className = "introjs-button introjs-skipbutton"),
        (_.href = "javascript:void(0);"),
        (_.innerHTML = this._options.skipLabel),
        (_.onclick = function () {
          e._introItems.length - 1 == e._currentStep &&
            "function" == typeof e._introCompleteCallback &&
            e._introCompleteCallback.call(e),
            e._introItems.length - 1 != e._currentStep &&
              "function" == typeof e._introExitCallback &&
              e._introExitCallback.call(e),
            l.call(e, e._targetElement);
        }),
        P.appendChild(_),
        this._introItems.length > 1 && (P.appendChild(w), P.appendChild(C)),
        I.appendChild(P),
        a.call(e, t.element, I, L, z);
    }
    this._options.disableInteraction === !0 && u.call(e),
      w.removeAttribute("tabIndex"),
      C.removeAttribute("tabIndex"),
      0 == this._currentStep && this._introItems.length > 1
        ? ((w.className = "introjs-button introjs-prevbutton introjs-disabled"),
          (w.tabIndex = "-1"),
          (C.className = "introjs-button introjs-nextbutton"),
          (_.innerHTML = this._options.skipLabel))
        : this._introItems.length - 1 == this._currentStep ||
          1 == this._introItems.length
        ? ((_.innerHTML = this._options.doneLabel),
          (w.className = "introjs-button introjs-prevbutton"),
          (C.className = "introjs-button introjs-nextbutton introjs-disabled"),
          (C.tabIndex = "-1"))
        : ((w.className = "introjs-button introjs-prevbutton"),
          (C.className = "introjs-button introjs-nextbutton"),
          (_.innerHTML = this._options.skipLabel)),
      C.focus(),
      (t.element.className += " introjs-showElement");
    var D = f(t.element, "position");
    "absolute" !== D &&
      "relative" !== D &&
      (t.element.className += " introjs-relativePosition");
    for (
      var K = t.element.parentNode;
      null != K && "body" !== K.tagName.toLowerCase();
      ...
      var V = f(K, "z-index"),
        ...
        $ =
          f(K, "transform") ||
          f(K, "-webkit-transform") ||
          f(K, "-moz-transform") ||
          f(K, "-ms-transform") ||
          f(K, "-o-transform");
      (/[0-9]+/.test(V) || 1 > W || "none" !== $) &&
        (K.className += " introjs-fixParent"),
        (K = K.parentNode);
    }
    if (!g(t.element) && this._options.scrollToElement === !0) {
      var F = t.element.getBoundingClientRect(),
        ...
        G = F.bottom - Z;
      0 > J || t.element.clientHeight > Z
        ? window.scrollBy(0, J - 30)
        : window.scrollBy(0, G + 100);
    }
...
//       t.appendChild(e),
//       (e.onclick = function () {
//         1 == o._options.exitOnOverlayClick &&
//           (l.call(o, t),
//           void 0 != o._introExitCallback && o._introExitCallback.call(o));
//       }),
//       setTimeout(function () {
//         (n += "opacity: " + o._options.overlayOpacity.toString() + ";"),
//           e.setAttribute("style", n);
//       }, 10),
//       !0
//     );
//   }
  function b(t) {
    ...
    for (var n = 0, o = 0; t && !isNaN(t.offsetLeft) && !isNaN(t.offsetTop); )
    ...
    (C.fn = e.prototype =
      {
        ...
        refresh: function () {
          return (
            p.call(this, document.querySelector(".introjs-helperLayer")),
            p.call(
              this,
