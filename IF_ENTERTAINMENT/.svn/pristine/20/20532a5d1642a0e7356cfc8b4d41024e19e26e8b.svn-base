		...
		method="post" id="registerForm" enctype="multipart/form-data">
			<div class="row">
				...
				<div class="col-lg-6 col-sm-12">
					...
					<input type="password" id="arPw" name="arPw" placeholder="비밀번호" >
				</div>
				<div class="col-lg-6 col-sm-12">
					<label>비밀번호 확인<span>*</span></label>
					<input type="password" id="arPw1" name="arPw1" placeholder="비밀번호 확인" value="${auditionRegisterVO.arPw1 }">
				</div>
				<div class="col-lg-6 col-sm-12">
...
<!-- 					</video> -->
				...
				<div class="col-lg-12 col-sm-12">
					<div class="checkbox">
					<label>
						<input type="checkbox"  id="check"><i class="check-box" style="border: 1px solid #000;"></i>
