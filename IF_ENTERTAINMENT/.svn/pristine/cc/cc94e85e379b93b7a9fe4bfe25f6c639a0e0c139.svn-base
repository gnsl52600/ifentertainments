...
<div class="gap inner-bg">
  ...
  <div class="little-heading">
  	<h2 style="margin-bottom: 30px; font-family: 'GmarketSansMedium';">🖍️ 상품 취소 내역</h2>
  </div>
    ...
    <div class="widget">
    	<div class="totalCount" style="margin-top: 20px; height: 40px;">
        	<span style="font-weight: 600; color: red; padding: 20px 0px 10px 20px;">총 취소 건 수 : ${pagingVO.totalRecord }</span>
       	</div>
