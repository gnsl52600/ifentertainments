	...
	<div class="modal-background">
		<div class="modal" id="modal">
			<div id='ifr' style="width: 100%; height: 100%;">
				<iframe
					src='https://www.vchatcloud.com/chat-demo/iframe/iframe_pc/v4/index.html?channelKey=cEgYDvdrBu-Kme7mhhyxq-20240516214404&youtubeId=YQE33AbZMYg'
		...
		<div class="container" style="position: relative; padding-bottom: 10%; height: 0;">
			<ul class="contributorz">
				<li><iframe width="960" height="324"
						src="https://www.youtube.com/embed/aIvKzWxnXHE?autoplay=1&mute=1&controls=0&loop=1&playlist=aIvKzWxnXHE"
				...
				<li><iframe width="960" height="324"
						src="https://www.youtube.com/embed/QgSiPeSeKZA?autoplay=1&mute=1&controls=0&loop=1&playlist=QgSiPeSeKZA"
...
<div id="auzModal" class="auzModal">
	<div class="auzModal-content">
		...
		<iframe id="auzIfr" style="width: 100%; height: 95%;"
			src='https://www.metaville.co.kr/vgw/CEvcyqfxIW-s3CiDZKDDe-20240516215238'
