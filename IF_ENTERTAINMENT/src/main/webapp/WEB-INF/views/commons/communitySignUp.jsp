...
body {
  ...
  background-color: var(--white);
	background-image: url("${pageContext.request.contextPath}/resources/images/blackpink.jpg");
...
<form  action="${pageContext.request.contextPath}/community/communitySignUp" id="comForm" method="post" class="form" autocomplete="off" >
  ...
  <div class="form-inner">
    ...
    <div class="input-wrapper">
      <label for="login-username">😄 커뮤니티에 사용할 닉네임을 입력해주세요</label>
    ...
    <div class="btn-group">
      <button type="submit" id="comBtn" class="btn btn--primary">완료</button>
      <a class="btn--text" href="/community/main.do">메인으로 돌아가기</a>
    </div>
  </div>
  <sec:csrfInput/>
</form>
