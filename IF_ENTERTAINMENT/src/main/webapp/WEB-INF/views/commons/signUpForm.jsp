					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="reg-from" style="margin-top: 60px; margin-bottom: 100px;">
								<span> <a href="/signin.do"> 회원가입🧑‍🚀</a></span>
								...
								<form action="/signup.do" class="c-form" method="post" id="signupForm" enctype="multipart/form-data">
									<div class="row merged10">
										...
										<div class="col-lg-12 col-md-12 col-sm-12" style="display: flex; justify-content: space-between; align-items: center;">
											<input class="form-control mail-check-input" placeholder="인증번호 6자리를 입력해주세요!" disabled="disabled" maxlength="6" style="width: 60%;">
											<div>
												<button class="main-btn" type="button"  data-ripple="" id="mail-Check-Btn1">확인</button>
												<button class="main-btn" type="button"  data-ripple="" id="mail-Check-Btn" >인증번호 발송</button>
											</div>
										</div>
...
<!-- 											<div class="col-sm-6"> -->
<!-- 												<div class="g-recaptcha" data-sitekey="6LfvK94pAAAAAOzQVKPVQSN67-vexxR4u_28WOi2"></div> -->
<!-- 												<span id="recaptchaError" class="rq"></span> -->
<!-- 											</div> -->
												<img alt="" src="${pageContext.request.contextPath }/resources/images/cap.png" style="width: 300px; cursor: pointer;">
										</div>
										...
										<div class="col-lg-8 col-md-6 mt-2">
											...
											<ul class="social-reg">
												<li><a class="facebook" href="/goods/main.do" title="" data-ripple="">굿즈샵 이용</a></li>
												<li><a class="twitter" href="/community/main.do" title="" data-ripple="">IF 커뮤니티</a></li>
											</ul>
										</div>
...
function codeCheck() {
    ...
    if (inputCode === code) {
        ...
        $resultMsg.css('margin', '2% 0 2%');
        $resultMsg.css('padding', '0 5px');
    }
}
