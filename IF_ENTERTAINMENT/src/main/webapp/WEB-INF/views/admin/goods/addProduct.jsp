    ...
    <div class="inner-bg">
        ...
        <div class="add-prod-from">
            <form method="post" action="/goods/insert.do" id="prodForm" enctype="multipart/form-data">
                ...
                <div class="row row-addproduct" style="width: 1030px; margin: 0 auto;">
                	
                	<!-- 자동입력버튼 -->
                	<div class="buttonz addpro_buttonz">
				    	<button type="button" id="autobutton" style="position: absolute;">자동입력 버튼</button>
				    </div>
                    ...
                    <div class="col-md-5 approv-reject">
                        <div class="addproduct-title">
                            <span>진열 여부</span>
                        </div>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="form-balju">
                            ...
                            <input class="form-control" id="goodsLimit" name="goodsLimit" style="width: 20%" type="text" value="${prod.goodsLimit }">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="form-balju">
                            <input class="form-control" id="goodsAutocndtn" name="goodsAutocndtn" style="width: 20%" type="text" value="${prod.goodsAutocndtn }">
                            <p style="display: inline">개 이하일때</p>
                            <input class="form-control" id="goodsAutobuycount" name="goodsAutobuycount" style="width: 20%" type="text" value="${prod.goodsAutobuycount }">
	...
	$(function () {
		...
		addBtn.on("click", function name() {
			...
			if ($(this).val() == "등록") {
			    ...
			    if (!$("#new").prop("checked") && !$("#only").prop("checked") && !$("#reservation").prop("checked") && !$("#membership").prop("checked")) {
			        Swal.fire(
			            '태그를 선택해주세요.',
			            '',
			            'warning'
		...
		$("#autobutton").on("click", function () {
			$("#goodsArtist option:eq(0)").prop("selected", true);
// 			$("#gcId option:eq(0)").prop("selected", true);
			$("#goodsName").val("[ON-OFF 22-23] FILM PHOTO SET (10% off ver.)");
			$("#goodsPrice").val("13000");
			$("#goodsQuantity").val("50");
			$("#goodsLimit").val("3");
			$("#goodsAutocndtn").val("5");
			$("#goodsAutobuycount").val("30");
		});
