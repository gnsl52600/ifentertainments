				...
				<div class="row">
					<div class="col-md-12">
						<label>제목</label> <input type="text" id="bfTitle" name="bfTitle"
							value="${companyNews.bfTitle }" placeholder="제목을 입력해주세요">
					</div>
					<div class="col-md-12">
						<label>내용 입력</label>
	...
	$(function() {
		...
		listBtn.on("click", function() {
			...
			swal(
					...
					'등록 취소',
					'계속 작성',
					"/entertain/company/news/list.do"
			);
		});
		...
		addBtn.on("click", function() {
			...
			var actionUrl = "/entertain/company/news/insert.do";
		    var successMessage = "게시물 등록 성공!";
		    
		    if ($(this).text() == "수정") {
		        actionUrl = "/entertain/company/news/update.do";
		        successMessage = "게시물 수정 성공!";
		    }
		    
		    CompanyNewsForm.attr("action", actionUrl);
		...
		deleteBtn.on("click", function () {
			swal(
					...
					'삭제',
					'취소',
					"/entertain/company/news/delete.do?bfNo=${bfNo}"
			);
		});
