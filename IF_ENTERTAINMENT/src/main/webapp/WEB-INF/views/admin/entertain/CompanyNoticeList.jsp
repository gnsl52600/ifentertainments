...
<div class="gap no-gap">
	<div class="inner-bg">
		<div class="element-title">
			<h3 style="font-family: 'GmarketSansMedium';">📢 기업공지</h3>
			<br />
						...
						<div class="col-md-6">
							<form method="post" id="searchForm" style="display: flex;">
								<input type="hidden" name="page" id="page" /> <input type="text"
									name="searchWord" value="${searchWord}" placeholder="검색"
					...
					<c:choose>
						...
						<c:otherwise>
							<c:forEach items="${CompanyNoticeList }" var="companyNotice">
								<tr class="prodList">
									<td style="padding-left: 0;">${companyNotice.bfNo }</td>
									...
									<td><font class="badge badge-danger"
										style="font-size: 14px;"> ${companyNotice.bfWriter } </font></td>
									<td style="text-align: center; padding-right: 0;"><c:choose>
											<c:when test="${companyNotice.bfDelyn eq 'Y' }">
         									   삭제완료
      									    </c:when>
											<c:otherwise>
												<span class="delete-icon"> <a
													href="/entertain/company/notice/delete.do?bfNo=${companyNotice.bfNo}">
	                ...
	                $.ajax({
	                    ...
	                    success: function(data) {
	                        Swal.fire(
	                            ...
	                            window.location.href = "/entertain/company/notice/list.do";
	                        });
	                    },
