			...
			<div class="row" style="width: 100%;">
				<div class="con_view_box" style="width: 100%;">
					<div class="widget-title" style="width: 100%;">
						<h3>${companyNews.bfTitle }</h3>
						<br /> <span class="c_writer" style="padding-left: 0px;">작성자
							${companyNews.bfWriter }</span> <span class="c_date">작성일 <fmt:formatDate
								value="${companyNews.bfRegdate }" pattern="yyyy-MM-dd HH:mm" /></span>
						<span class="c_date">삭제 ${companyNews.bfDelyn }</span>
					</div>
					<div class="widget-peding">${companyNews.bfContent }</div>
				</div>
				<div class="col-md-12">
					<div class="buttonz">
				...
				<form action="/entertain/company/news/delete.do" id="delForm"
					method="post">
...
<script>
	$(function() {
		...
		updateBtn.on("click", function() {
			...
			delForm.attr("action", "/entertain/company/news/update.do");
			delForm.submit();
		});
